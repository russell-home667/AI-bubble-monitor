(() => {
  ...
  function aviationDataZoom(chartId) {
    return [
      ...
      {type:'slider',xAxisIndex:0,height:18,bottom:9,left:50,right:24,realtime:true,borderColor:'rgba(70,193,255,.10)',backgroundColor:'rgba(4,12,20,.30)',fillerColor:'rgba(70,193,255,.13)',handleStyle:{color:'#0d1828',borderColor:'#46c1ff',borderWidth:1.4},moveHandleStyle:{color:'rgba(142,172,201,.78)'},textStyle:{color:'#647f92'},showDetail:false,showDataShadow:chartId!=='liquidityChart',brushSelect:true,zoomLock:false}
    ];
  }
