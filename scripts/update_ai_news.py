...
def chat_json(key,mode,cands):
 ...
 body={'model':MODEL,'messages':[{'role':'system','content':system},{'role':'user','content':prompt}],'thinking':{'type':'enabled','reasoning_effort':'high' if mode=='deep' else 'low'},'response_format':{'type':'json_object'},'max_tokens':10000 if mode=='deep' else 7000}
